...
type ActivityList struct {
	...
	ActivityScheduleStartDate string `json:"activity_schedule_start_date"`
	ActivityScheduleEndDate   string `json:"activity_schedule_end_date"`
	ActivityScheduleStarted   string `json:"activity_schedule_started"`
	ActivityScheduleEnded     string `json:"activity_schedule_ended"`
	ActivityScheduleNote      string `json:"activity_schedule_note"`
	IdActivityMstType         int64  `json:"id_activity_mst_type"`
