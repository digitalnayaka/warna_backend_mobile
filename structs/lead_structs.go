...
type LeadCollabListing struct {
	...
	IdMstLogDesc   int64  `json:"id_mst_log_desc"`
	IdMstLogStatus int64  `json:"id_mst_log_status"`
...
type LeadSearch struct {
	...
	CreatedAtLead  string `json:"created_at_lead"`
}
