...
type Order struct {
	...
	NoOrder string `gorm:"default:'(SELECT 
concat(to_char(now(),'YYYYMM'), 'OR' , 
LPAD( cast((select count(id)+1 from "order" where created_at >= now()::date) as text),6,'0')))'" json:"no_order"`
...
type OrderUfi struct {
	...
	OtrTaksasi 	int `gorm:"default:'null'" json:"otr_taksasi"`
...
type OrderLoan struct {
	...
	UpdatedAt string `gorm:"default:'null'" json:"updated_at"`
	IdOrder int64 `gorm:"default:'null'" json:"id_order"`
	OtrCustom int `gorm:"default:'null'" json:"otr_custom"`
	Plafond int `gorm:"default:'null'" json:"plafond"`
	DownPayment int `gorm:"default:'null'" json:"down_payment"`
	Installment int `gorm:"default:'null'" json:"installment"`
	Tenor int `gorm:"default:'null'" json:"tenor"`
...
type OrderSurety struct {
	...
	WorkingTime int `gorm:"default:'null'" json:"working_time"`
	Income int `gorm:"default:'null'" json:"income"`
	Outlay int `gorm:"default:'null'" json:"outlay"`
	IdCmsUsers int64 `gorm:"default:'null'" json:"id_cms_users"`
	UpdatedBy int64 `gorm:"default:'null'" json:"updated_by"`
}
...
type OrderDetail struct {
	...
	OrderSurety OrderSurety `json:"order_surety"`
